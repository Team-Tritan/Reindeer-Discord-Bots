  ...
  reindeer.on("message", (message: any) => {
    ...
    if (ctn.includes(`<@!${self_id}> help`)) {
      let embed = new Discord.MessageEmbed()
        ...
        .setImage(
          "https://media.discordapp.net/attachments/893557986964959252/909628316707872818/Screen_Shot_2021-11-14_at_9.18.04_PM.png"
        )
        .setFooter(`Happy holidays from Tritan Development!`);
